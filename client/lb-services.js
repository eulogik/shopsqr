  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Customer.users() instead.
        "::get::Customer::users": {
          url: urlBase + "/Customers/:id/users",
          method: "GET"
        },

        // INTERNAL. Use Customer.users.create() instead.
        "::create::Customer::users": {
          url: urlBase + "/Customers/:id/users",
          method: "POST"
        },

        // INTERNAL. Use Customer.users.createMany() instead.
        "::createMany::Customer::users": {
          isArray: true,
          url: urlBase + "/Customers/:id/users",
          method: "POST"
        },

        // INTERNAL. Use Customer.users.update() instead.
        "::update::Customer::users": {
          url: urlBase + "/Customers/:id/users",
          method: "PUT"
        },

        // INTERNAL. Use Customer.users.destroy() instead.
        "::destroy::Customer::users": {
          url: urlBase + "/Customers/:id/users",
          method: "DELETE"
        },
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Product.variants.findById() instead.
        "prototype$__findById__variants": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Products/:id/variants/:fk",
          method: "GET"
        },

        // INTERNAL. Use Product.variants.destroyById() instead.
        "prototype$__destroyById__variants": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Products/:id/variants/:fk",
        ...
        // INTERNAL. Use Product.variants.updateById() instead.
        "prototype$__updateById__variants": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Products/:id/variants/:fk",
        ...
        // INTERNAL. Use Product.variants() instead.
        "prototype$__get__variants": {
          isArray: true,
          url: urlBase + "/Products/:id/variants",
          method: "GET"
        },

        // INTERNAL. Use Product.variants.create() instead.
        "prototype$__create__variants": {
          url: urlBase + "/Products/:id/variants",
          method: "POST"
        },

        // INTERNAL. Use Product.variants.destroyAll() instead.
        "prototype$__delete__variants": {
          url: urlBase + "/Products/:id/variants",
          method: "DELETE"
        },

        // INTERNAL. Use Product.variants.count() instead.
        "prototype$__count__variants": {
          url: urlBase + "/Products/:id/variants/count",
          method: "GET"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Product#getPriceRange
         * @methodOf lbServices.Product
         *
         * @description
         *
         ...
         */
        "getPriceRange": {
          url: urlBase + "/Products/getPriceRange",
          method: "POST"
        },
        ...
        // INTERNAL. Use Variant.product() instead.
        "::get::Variant::product": {
          url: urlBase + "/Variants/:id/product",
          method: "GET"
        },
      }
    );
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Product.variants
     * @header lbServices.Product.variants
     * @object
     * @description
     *
     * The object `Product.variants` groups methods
     * manipulating `Variant` instances related to `Product`.
     *
     * Call {@link lbServices.Product#variants Product.variants()}
     ...
     */
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Variant` object.)
         * </em>
         */
        R.variants = function() {
          var TargetResource = $injector.get("Variant");
          var action = TargetResource["::get::Product::variants"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Product.variants#count
         * @methodOf lbServices.Product.variants
         *
         * @description
         *
         * Counts variants of Product.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         *  - `count` – `{number=}` - 
         */
        R.variants.count = function() {
          var TargetResource = $injector.get("Variant");
          var action = TargetResource["::count::Product::variants"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Product.variants#create
         * @methodOf lbServices.Product.variants
         *
         * @description
         *
         * Creates a new instance in variants of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.variants.create = function() {
          var TargetResource = $injector.get("Variant");
          var action = TargetResource["::create::Product::variants"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Product.variants#createMany
         * @methodOf lbServices.Product.variants
         *
         * @description
         *
         ...
         * </em>
         */
        R.variants.createMany = function() {
          var TargetResource = $injector.get("Variant");
          var action = TargetResource["::createMany::Product::variants"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Product.variants#destroyAll
         * @methodOf lbServices.Product.variants
         *
         * @description
         *
         * Deletes all variants of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * This method returns no data.
         */
        R.variants.destroyAll = function() {
          var TargetResource = $injector.get("Variant");
          var action = TargetResource["::delete::Product::variants"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Product.variants#destroyById
         * @methodOf lbServices.Product.variants
         *
         * @description
         *
         * Delete a related item by id for variants.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         *
         *  - `fk` – `{*}` - Foreign key for variants
         *
         * @param {function(Object,Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         * This method returns no data.
         */
        R.variants.destroyById = function() {
          var TargetResource = $injector.get("Variant");
          var action = TargetResource["::destroyById::Product::variants"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Product.variants#findById
         * @methodOf lbServices.Product.variants
         *
         * @description
         *
         * Find a related item by id for variants.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.variants.findById = function() {
          var TargetResource = $injector.get("Variant");
          var action = TargetResource["::findById::Product::variants"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Product.variants#updateById
         * @methodOf lbServices.Product.variants
         *
         * @description
         *
         * Update a related item by id for variants.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.variants.updateById = function() {
          var TargetResource = $injector.get("Variant");
          var action = TargetResource["::updateById::Product::variants"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Category.category() instead.
        "prototype$__get__category": {
          url: urlBase + "/Categories/:id/category",
          method: "GET"
        },
    ...
    */
    R.modelName = "Category";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Category#category
         * @methodOf lbServices.Category
         *
         * @description
         *
        ...
        R.category = function() {
          var TargetResource = $injector.get("Category");
          var action = TargetResource["::get::Category::category"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Variant#create
         * @methodOf lbServices.Variant
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         */
        "create": {
          url: urlBase + "/Variants",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Variant#createMany
         * @methodOf lbServices.Variant
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Variant#upsert
         * @methodOf lbServices.Variant
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Variant#exists
         * @methodOf lbServices.Variant
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/Variants/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Variant#findById
         * @methodOf lbServices.Variant
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/Variants/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Variant#find
         * @methodOf lbServices.Variant
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Variant#findOne
         * @methodOf lbServices.Variant
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/Variants/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Variant#updateAll
         * @methodOf lbServices.Variant
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/Variants/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Variant#deleteById
         * @methodOf lbServices.Variant
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/Variants/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Variant#prototype$updateAttributes
         * @methodOf lbServices.Variant
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Variant#createChangeStream
         * @methodOf lbServices.Variant
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/Variants/change-stream",
          method: "POST"
        },

        // INTERNAL. Use Product.variants.findById() instead.
        "::findById::Product::variants": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Products/:id/variants/:fk",
        ...
        // INTERNAL. Use Product.variants.createMany() instead.
        "::createMany::Product::variants": {
          isArray: true,
          url: urlBase + "/Products/:id/variants",
          method: "POST"
        },
        ...
        // INTERNAL. Use StockEntry.variant() instead.
        "::get::stockEntry::variant": {
          url: urlBase + "/stockEntries/:id/variant",
          method: "GET"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.Variant#updateOrCreate
         * @methodOf lbServices.Variant
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Variant#update
         * @methodOf lbServices.Variant
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Variant#destroyById
         * @methodOf lbServices.Variant
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Variant#removeById
         * @methodOf lbServices.Variant
         *
         * @description
         *
    ...
    */
    R.modelName = "Variant";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Variant#product
         * @methodOf lbServices.Variant
         *
         * @description
         *
        ...
        R.product = function() {
          var TargetResource = $injector.get("Product");
          var action = TargetResource["::get::Variant::product"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Cart.customer() instead.
        "prototype$__get__customer": {
          url: urlBase + "/Carts/:id/customer",
          method: "GET"
        },
         ...
         */
        "viewCart": {
          url: urlBase + "/Carts/viewCart",
          method: "POST"
        },

        // INTERNAL. Use Customer.carts.findById() instead.
        "::findById::Customer::carts": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/carts/:fk",
          method: "GET"
        },

        // INTERNAL. Use Customer.carts.destroyById() instead.
        "::destroyById::Customer::carts": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/carts/:fk",
        ...
        // INTERNAL. Use Customer.carts.updateById() instead.
        "::updateById::Customer::carts": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/carts/:fk",
        ...
        // INTERNAL. Use Customer.carts() instead.
        "::get::Customer::carts": {
          isArray: true,
          url: urlBase + "/Customers/:id/carts",
          method: "GET"
        },

        // INTERNAL. Use Customer.carts.create() instead.
        "::create::Customer::carts": {
          url: urlBase + "/Customers/:id/carts",
          method: "POST"
        },

        // INTERNAL. Use Customer.carts.createMany() instead.
        "::createMany::Customer::carts": {
          isArray: true,
          url: urlBase + "/Customers/:id/carts",
          method: "POST"
        },

        // INTERNAL. Use Customer.carts.destroyAll() instead.
        "::delete::Customer::carts": {
          url: urlBase + "/Customers/:id/carts",
          method: "DELETE"
        },

        // INTERNAL. Use Customer.carts.count() instead.
        "::count::Customer::carts": {
          url: urlBase + "/Customers/:id/carts/count",
          method: "GET"
        },
      }
    );
    ...
    */
    R.modelName = "Cart";
        ...
        R.customer = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::get::Cart::customer"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.StockEntry
 * @header lbServices.StockEntry
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `StockEntry` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.StockEntry#create
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `StockEntry` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/stockEntries",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.StockEntry#createMany
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.StockEntry#upsert
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.StockEntry#exists
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/stockEntries/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.StockEntry#findById
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/stockEntries/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.StockEntry#find
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.StockEntry#findOne
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/stockEntries/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.StockEntry#updateAll
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/stockEntries/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.StockEntry#deleteById
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.StockEntry#count
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/stockEntries/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.StockEntry#prototype$updateAttributes
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.StockEntry#createChangeStream
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/stockEntries/change-stream",
          method: "POST"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.StockEntry#updateOrCreate
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.StockEntry#update
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.StockEntry#destroyById
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.StockEntry#removeById
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.StockEntry#modelName
    * @propertyOf lbServices.StockEntry
    * @description
    * The name of the model represented by this $resource,
    * i.e. `StockEntry`.
    */
    R.modelName = "StockEntry";


        /**
         * @ngdoc method
         * @name lbServices.StockEntry#variant
         * @methodOf lbServices.StockEntry
         *
         * @description
         *
         * Fetches belongsTo relation variant.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.variant = function() {
          var TargetResource = $injector.get("Variant");
          var action = TargetResource["::get::stockEntry::variant"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Customer.carts.destroyById() instead.
        "prototype$__destroyById__carts": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/carts/:fk",
        ...
        // INTERNAL. Use Customer.carts.create() instead.
        "prototype$__create__carts": {
          url: urlBase + "/Customers/:id/carts",
          method: "POST"
        },

        // INTERNAL. Use Customer.carts.destroyAll() instead.
        "prototype$__delete__carts": {
          url: urlBase + "/Customers/:id/carts",
          method: "DELETE"
        },

        // INTERNAL. Use Customer.carts.count() instead.
        "prototype$__count__carts": {
          url: urlBase + "/Customers/:id/carts/count",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Customer.carts
     * @header lbServices.Customer.carts
     * @object
     * @description
     *
     * The object `Customer.carts` groups methods
     * manipulating `Cart` instances related to `Customer`.
     *
     * Call {@link lbServices.Customer#carts Customer.carts()}
     * to query all related instances.
     */
        ...
        R.carts = function() {
          ...
          var action = TargetResource["::get::Customer::carts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.carts#count
         * @methodOf lbServices.Customer.carts
         *
         * @description
         *
         * Counts carts of Customer.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         *  - `count` – `{number=}` - 
         */
        R.carts.count = function() {
          var TargetResource = $injector.get("Cart");
          var action = TargetResource["::count::Customer::carts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.carts#create
         * @methodOf lbServices.Customer.carts
         *
         * @description
         *
         ...
         * </em>
         */
        R.carts.create = function() {
          var TargetResource = $injector.get("Cart");
          var action = TargetResource["::create::Customer::carts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.carts#createMany
         * @methodOf lbServices.Customer.carts
         *
         * @description
         *
         ...
         * </em>
         */
        R.carts.createMany = function() {
          var TargetResource = $injector.get("Cart");
          var action = TargetResource["::createMany::Customer::carts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.carts#destroyAll
         * @methodOf lbServices.Customer.carts
         *
         * @description
         *
         ...
         * This method returns no data.
         */
        R.carts.destroyAll = function() {
          var TargetResource = $injector.get("Cart");
          var action = TargetResource["::delete::Customer::carts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.carts#destroyById
         * @methodOf lbServices.Customer.carts
         *
         * @description
         *
         ...
         * This method returns no data.
         */
        R.carts.destroyById = function() {
          var TargetResource = $injector.get("Cart");
          var action = TargetResource["::destroyById::Customer::carts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.carts#findById
         * @methodOf lbServices.Customer.carts
         *
         * @description
         *
         ...
         * </em>
         */
        R.carts.findById = function() {
          var TargetResource = $injector.get("Cart");
          var action = TargetResource["::findById::Customer::carts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.carts#updateById
         * @methodOf lbServices.Customer.carts
         *
         * @description
         *
         ...
         * </em>
         */
        R.carts.updateById = function() {
          var TargetResource = $injector.get("Cart");
          var action = TargetResource["::updateById::Customer::carts"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
    ...
    /**
     * @ngdoc object
     * @name lbServices.Customer.users
     * @header lbServices.Customer.users
     * @object
     * @description
     *
     * The object `Customer.users` groups methods
     * manipulating `User` instances related to `Customer`.
     *
     * Call {@link lbServices.Customer#users Customer.users()}
     * to query all related instances.
     */
        ...
        R.users = function() {
          ...
          var action = TargetResource["::get::Customer::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.users#create
         * @methodOf lbServices.Customer.users
         *
         * @description
         *
        ...
        R.users.create = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::create::Customer::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.users#createMany
         * @methodOf lbServices.Customer.users
         *
         * @description
         *
        ...
        R.users.createMany = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::createMany::Customer::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.users#destroy
         * @methodOf lbServices.Customer.users
         *
         * @description
         *
        ...
        R.users.destroy = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::destroy::Customer::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.users#update
         * @methodOf lbServices.Customer.users
         *
         * @description
         *
        ...
        R.users.update = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::update::Customer::users"];
          return action.apply(R, arguments);
        };
 ...
 * @ngdoc object
 * @name lbServices.Zip
 * @header lbServices.Zip
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Zip` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Zip#create
         * @methodOf lbServices.Zip
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Zip` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/Zips",
        ...
        /**
         * @ngdoc method
         * @name lbServices.Zip#createMany
         * @methodOf lbServices.Zip
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/Zips/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Zip#findById
         * @methodOf lbServices.Zip
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/Zips/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Zip#updateAll
         * @methodOf lbServices.Zip
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/Zips/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Zip#deleteById
         * @methodOf lbServices.Zip
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/Zips/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Zip#prototype$updateAttributes
         * @methodOf lbServices.Zip
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Zip#createChangeStream
         * @methodOf lbServices.Zip
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/Zips/change-stream",
          method: "POST"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.Zip#updateOrCreate
         * @methodOf lbServices.Zip
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Zip#destroyById
         * @methodOf lbServices.Zip
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Zip#removeById
         * @methodOf lbServices.Zip
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Zip#modelName
    * @propertyOf lbServices.Zip
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Zip`.
    */
